...
template void launch_bias_gelu<__nv_bfloat16>(__nv_bfloat16*, const __nv_bfloat16*, int, int, cudaStream_t);
...
template void launch_fused_bias_geglu(__half*, const __half*, const __half*, int, int, cudaStream_t);
template void launch_fused_bias_geglu(__nv_bfloat16*, const __nv_bfloat16*, const __nv_bfloat16*, int, int, cudaStream_t);
