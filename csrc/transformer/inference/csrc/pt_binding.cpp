...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("softmax_context_fp32", &ds_softmax_context<float>, "DeepSpeed attention with fp32 (CUDA)");
    m.def("softmax_context_bf16", &ds_softmax_context<__nv_bfloat16>,"DeepSpeed attention with bf16 (CUDA)");
    m.def("softmax_context_fp16", &ds_softmax_context<__half>,"DeepSpeed attention with fp16 (CUDA)");
    m.def("softmax_context_int8", &ds_softmax_context1<__half>, "DeepSpeed attention with int8 (CUDA)");
    ...
    m.def("bias_residual_fp32", &ds_bias_residual<float>, "DeepSpeed residual-bias add with fp32 (CUDA)");
    m.def("bias_residual_bf16", &ds_bias_residual<__nv_bfloat16>,"DeepSpeed residual-bias add with bf16 (CUDA)");
    m.def("bias_residual_fp16", &ds_bias_residual<__half>,"DeepSpeed residual-bias add with fp16 (CUDA)");
    m.def("layer_norm", &ds_layer_norm, "DeepSpeed layer norm (CUDA)");
    m.def("_layer_norm_residual", &ds_layer_norm_residual, "DeepSpeed layer norm + residual (CUDA)");
    ...
    m.def("vector_matmul_bf16", &ds_vector_matmul<__nv_bfloat16>, "DeepSpeed vector-MM with bf16 (CUDA)");
    m.def("vector_matmul_fp16", &ds_vector_matmul<__half>, "DeepSpeed vector-MM with fp16 (CUDA)");
    m.def("vector_matmul_int8", &ds_vector_matmul_int8<__half>, "DeepSpeed vector-MM with int8 (CUDA)");
    m.def("linear_layer_fp32", &ds_linear_layer<float>, "DeepSpeed linear_layer with fp32 (CUDA)");
    m.def("linear_layer_bf16", &ds_linear_layer<__nv_bfloat16>, "DeepSpeed linear_layer with bf16 (CUDA)");
    m.def("linear_layer_fp16", &ds_linear_layer<__half>, "DeepSpeed linear_layer with fp16 (CUDA)");
    m.def("linear_layer_int8", &ds_linear_layer_int8<__half>, "DeepSpeed linear_layer with int8 (CUDA)");
    m.def("fused_gemm_gelu_fp32", &fused_gemm_gelu<float>, "DeepSpeed mlp with fp32 (CUDA)");
    m.def("fused_gemm_gelu_bf16", &fused_gemm_gelu<__nv_bfloat16>, "DeepSpeed mlp with bf16 (CUDA)");
    m.def("fused_gemm_gelu_fp16", &fused_gemm_gelu<__half>, "DeepSpeed mlp with fp16 (CUDA)");
    m.def("residual_add_bias_fp32", &residual_add_bias<float>, "DeepSpeed residual add with fp32 (CUDA)");
    m.def("residual_add_bias_bf16", &residual_add_bias<__nv_bfloat16>, "DeepSpeed residual add with bf16 (CUDA)");
    m.def("residual_add_bias_fp16", &residual_add_bias<__half>, "DeepSpeed residual add with fp16 (CUDA)");
    ...
    m.def("add_padding_bf16", &add_padding<__nv_bfloat16>, "DeepSpeed residual add with bf16 (CUDA)");
